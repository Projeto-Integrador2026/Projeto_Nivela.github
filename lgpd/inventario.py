...
DADOS_PESSOAIS = [
    ...
    {
        "dado": "Telefone",
        "origem": "Informado pelo titular (campo opcional; hoje só pode ser preenchido via admin, sem tela própria no sistema)",
    ...
    {
        "dado": "Progresso nas lições (concluída ou não, data de conclusão)",
        "origem": "Gerado pelo sistema conforme o titular avança nos módulos",
        "armazenamento": "gamificacao_progressolicao",
        "finalidade": "Controlar o avanço do titular na trilha de aprendizado",
        "base_legal": CONTRATO,
        "obrigatorio": True,
        "protecao": "Acesso restrito ao banco",
        "retencao": "Enquanto a conta existir",
    ...
    {
        "dado": "Tentativas de exercícios (acerto/erro e data)",
        "origem": "Gerada a cada resposta enviada pelo titular",
        "armazenamento": "gamificacao_tentativaexercicio",
        "finalidade": "Avaliar o desempenho do titular e liberar os próximos módulos",
        "base_legal": CONTRATO,
        "obrigatorio": True,
        "protecao": "Acesso restrito ao banco",
        "retencao": "Enquanto a conta existir",
    ...
    {
        "dado": "Perfil de gamificação (XP, streak atual e recorde, última atividade)",
        "origem": "Calculado pelo sistema a partir do uso da plataforma",
        "armazenamento": "gamificacao_perfilgamificacao",
        "finalidade": "Gamificação: ranking, nível e sequência de estudo (XP, streak)",
        "base_legal": CONTRATO,
        "obrigatorio": True,
        "protecao": "Acesso restrito ao banco",
        "retencao": "Enquanto a conta existir",
    ...
    {
        "dado": "Resultado do teste de nivelamento e liberações manuais de módulo",
        "origem": "Gerado pelo sistema (teste) ou por um professor (liberação manual)",
        "armazenamento": "gamificacao_resultadonivelamento e gamificacao_liberacaomanual",
        "finalidade": "Definir o módulo inicial do titular e registrar liberações concedidas por um professor",
        "base_legal": LEGITIMO_INTERESSE,
        "obrigatorio": False,
        "protecao": "Acesso restrito ao banco",
        "retencao": "Enquanto a conta existir",
